...
For example, if you would like to view the total RAM installed on each of the [servers](https://www.ocf.berkeley.edu/docs/staff/backend/servers/) you can query `node_memory_Active_bytes{host_type="server"}`.
...
The frontend for Prometheus is [Grafana][grafana], which displays statistics collected by Prometheus in a user-friendly manner. Some of the more useful dashboards available are:
 ...
 - **[HPC](hhttps://ocf.io/hpcstats):** Displays usage information for the [HPC cluster](../../user-docs/services/hpc/index.md).
