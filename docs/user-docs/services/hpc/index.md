...
your OCF username or [group account](../../membership/index.md#group-accounts) name
...
If you have trouble connecting please [contact us](../../contact/index.md) at
...
We also have a `#hpc_users` channel on OCF chat and [IRC](../../contact/chat.md)
...
Detailed documentation for how to access Slurm is [here](slurm.md).
